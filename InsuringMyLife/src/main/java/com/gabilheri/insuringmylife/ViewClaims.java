...
public class ViewClaims extends Activity {
    ...
    public void addClaims(View view) {
        Intent addClaims = new Intent(ViewClaims.this, ReportClaims.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            Intent aboutAAA = new Intent(ViewClaims.this, AboutAAA.class);
            startActivity(aboutAAA);
        } else if(id == 2) {
            Intent aboutIns = new Intent(ViewClaims.this, AboutInsuringMyLife.class);
